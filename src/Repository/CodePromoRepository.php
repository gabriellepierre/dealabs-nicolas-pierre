...
class CodePromoRepository extends ServiceEntityRepository
{
    ...
    public function getHotCodesPromoTries()
    {
        $query = $this->createQueryBuilder('code_promo');
        $query->where("code_promo.degreAttractivite >= 100")
            ->orderBy("code_promo.datePublication","ASC");
